...
> Branch wall override (`feature/ui-glass-redesign`): Attendance, Setup,
> Backup, and all popups now wear the black-and-cream wall (`#141414` /
> `#F4EEE1` / `#8A3A3A` destructive-only, glyph actions, cube fields,
> 4px scrollbars — see `docs/UI_COMPONENTS.md` logs 58+ and the wall
> section of `docs/UI_TOKENS.md`). The frost language below survives
> only for untouched surfaces (Students, kiosk/idle, print). On any
